      ...
      <div className=' mt-2 flex justify-center mx-auto  py-5'>
        <div className=' md:mt-[110px] '>
          ...
          <label htmlFor="">Firstname *</label><br />
            <input className='rounded-lg mx-1 my-5 py-1  px-8 md:px-12 text-black' type="text" /><br />
            <label htmlFor="">LastName</label><br />
            <input className=' rounded-md mx-1 my-5 py-1 px-8 md:px-12 text-black' type="text" /><br />
            <label htmlFor="">Email *</label><br />
            <input className=' rounded-md mx-1 my-5 py-1 px-8 md:px-12 text-black' type="email" /><br />
            <label htmlFor="">Industry</label><br />
            <input className=' rounded-md mx-1 my-5 py-1 px-8 md:px-12 text-black' type="text" /><br />
            <button className='border rounded-lg mt-5 items-center bg-emerald-500 font-bold tex-2xl border-spacing-3  py-2 px-[80px] md:px-[100px]  '>Claim Now</button>
